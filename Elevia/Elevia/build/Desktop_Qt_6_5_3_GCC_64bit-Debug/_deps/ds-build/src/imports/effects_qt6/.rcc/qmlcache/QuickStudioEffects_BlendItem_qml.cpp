...
0x50,0xb,0x0,0x0,0x64,0x66,0x61,0x33,
...
aotContext->setInstructionPointer(9);
aotContext->initGetObjectLookup(11, r2_0, QMetaType::fromType<QQmlListProperty<QObject>>());
if (aotContext->engine->hasError())
    return ;
}
// generate_StoreReg
...
while (!aotContext->setObjectLookup(12, r7_0, &converted)) {
aotContext->setInstructionPointer(17);
aotContext->initSetObjectLookup(12, r7_0, []() { static const auto t = QMetaType::fromName("QQuickItem*"); return t; }());
if (aotContext->engine->hasError())
    return ;
}
}
...
aotContext->initGetObjectLookup(15, r2_0, QMetaType::fromType<QQmlListProperty<QObject>>());
if (aotContext->engine->hasError())
    return ;
}
// generate_StoreReg
...
{
auto converted = aotContext->engine->fromVariant<QObject *>(r2_3);
while (!aotContext->setObjectLookup(16, r7_0, &converted)) {
aotContext->setInstructionPointer(34);
aotContext->initSetObjectLookup(16, r7_0, []() { static const auto t = QMetaType::fromName("QQuickItem*"); return t; }());
if (aotContext->engine->hasError())
    return ;
}
}
// generate_LoadRuntimeString
r2_4 = QStringLiteral("Blend is not supported with Qt 6");
// generate_StoreReg
r10_0 = r2_4;
// generate_CallPropertyLookup
{
