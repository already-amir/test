...
0x38,0xe,0x0,0x0,0x64,0x66,0x61,0x33,
...
// generate_GetLookup
while (!aotContext->getObjectLookup(16, r2_0, &r2_3)) {
...
r2_4 = QVariant::fromValue(retrieved);
}
// generate_Ret
if (!r2_4.isValid())
    aotContext->setReturnValueUndefined();
...
// generate_GetLookup
while (!aotContext->getObjectLookup(27, r2_0, &r2_3)) {
