...
0x3c,0xe,0x0,0x0,0x64,0x66,0x61,0x33,
...
aotContext->setInstructionPointer(9);
aotContext->initGetObjectLookup(27, r2_0, QMetaType::fromType<QQmlListProperty<QObject>>());
if (aotContext->engine->hasError())
    return ;
}
// generate_StoreReg
...
while (!aotContext->setObjectLookup(28, r7_0, &converted)) {
...
aotContext->initGetObjectLookup(31, r2_0, QMetaType::fromType<QQmlListProperty<QObject>>());
if (aotContext->engine->hasError())
    return ;
}
// generate_StoreReg
...
{
auto converted = aotContext->engine->fromVariant<QObject *>(r2_3);
while (!aotContext->setObjectLookup(32, r7_0, &converted)) {
aotContext->setInstructionPointer(34);
aotContext->initSetObjectLookup(32, r7_0, []() { static const auto t = QMetaType::fromName("QQuickItem*"); return t; }());
if (aotContext->engine->hasError())
    return ;
}
}
// generate_LoadRuntimeString
r2_4 = QStringLiteral("MaskedBlur is not supported with Qt 6");
// generate_StoreReg
r10_0 = r2_4;
// generate_CallPropertyLookup
{
